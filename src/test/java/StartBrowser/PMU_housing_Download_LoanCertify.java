...
public class PMU_housing_Download_LoanCertify {
...
//		dr.findElement(By.name("txtcaptcha")).sendKeys(Captchacode);
		...
		dr.get("https://pmuhousing.ap.gov.in/APSHCLPMU/OTS/LoanClearCert.aspx");
		...
		for(int r=2;r<s1.getLastRowNum();r++) {
			...
			Cell cell=row.getCell(c);
				...
				dr.findElement(By.xpath("//span[text()='Select']")).click();
				dr.findElement(By.xpath("//*[@type='search']")).sendKeys(cell.getStringCellValue(),Keys.ENTER);
				dr.findElement(By.id("ContentPlaceHolder1_btnCertificate")).click();
